...
exercise.chooseImage = function() {
    ...
    if (exercise.increment > 0) {
        if (exercise.flag === 1) {
            exercise.img1 = document.getElementById('PacMan1')

        } else {
            exercise.img1 = document.getElementById('PacMan2')

        }
    } else if (exercise.increment < 0) {
        if (exercise.flag === 1) {
            exercise.img1 = document.getElementById('PacMan3')

        } else {
            exercise.img1 = document.getElementById('PacMan4')
